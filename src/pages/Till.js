...
<ImageModal src="/app-assets/images/tillA.png" name={'retaurantTill'} link={'/till/restaurant'} alt="tillA" />
</div>
...
<p className="font-weight-bold mt-4">TYPE B: Suitable for picture rich inventory type operation. e.g restaurant, foodmart, bistrols,cafe, fashion store e.t.c</p>
         <div class="form-check">
            ...
            />
            <label class="form-check-label ml-4">
                <img src="/app-assets/images/tillB.png" alt="till B" data-toggle="modal" data-target="#gloceryTillModal" className="till-image"/>
...
<ImageModal src="/app-assets/images/tillB.png" name={'gloceryTill'} link={'/till/glocery'} alt="tillB" />
</div>
